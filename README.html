...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong>api/v1/update_ttlock_credential</strong></p>
<p>Обновить логин пароль для TTlock</p>
<p>{<br />"email" : "xxxx@rambler.ru",<br />"password" : "************",<br />}</p>
<p><span style="text-decoration: underline;">Ответ</span>:</p>
<p>{<br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;">"status'": "true",</span><br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;"> "msg" : "Пароль к облаку Ttlock изменен"</span><br />}</p>
<p><span style="text-decoration: underline;">Ошибки</span>:</p>
<p>&nbsp;</p>
<p>{<br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;">"status'": "false",</span><br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;"> "msg" : "Не удалось залогиниться&nbsp; в облако Ttlock"</span><br />}</p>
<p>&nbsp;</p>
<p>{<br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;">"status'": "false",</span><br /><span class="selectable-text copyable-text xkrh14z" style="white-space: pre-wrap;"> "msg" : "Не получилось запистать данные для авторизации в Ttlock"</span><br />}</p>
<p>&nbsp;</p>
...
<p>apt-get update apt-get install php8.2 apt-get install php8.2-mbstring php artisan fortify:install docker exec -it centrifugo centrifugo genconfig docker logs -f centrifugo</p>