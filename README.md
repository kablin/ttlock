...
<hr />
<p>&nbsp;</p>
<h3>Запросы к апи которые возвращают job_id с уникальным номером запроса. После выполнения запроса вызвается коллбэк пользователя куда передается результат</h3>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong>&nbsp;/v1/set_lock_passage_mode_off</strong></p>
...
<p><strong>/v1/get_lock_events</strong></p>
...
<p>&nbsp;</p>
<p><strong>/v1/get_lock_events2</strong></p>
...
<p><strong>&nbsp;/v1/get_events_by_code</strong></p>
