    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                ...
                <p class="text-sm">Ваш аккаунт будет полностью удален</p>
            </div>
            <Dialog>
                ...
                <DialogContent>
                    <Form v-bind="ProfileController.destroy.form()" reset-on-success
                        ...
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Как только ваша учетная запись будет удалена, все ее ресурсы и данные также будут
                                удалены безвозвратно. Пожалуйста, введите свой
                                пароль, чтобы подтвердить, что вы хотите удалить свою учетную запись безвозвратно.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            <Button type="submit" variant="destructive" :disabled="processing"
                                data-test="confirm-delete-user-button"> Удалить аккаунт </Button>
                        </DialogFooter>
                    </Form>
                </DialogContent>
            </Dialog>
