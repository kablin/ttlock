...
<template>
  <div class="min-h-screen bg-white flex flex-col">
    ...
    <div class="flex-1 px-6 py-8 max-w-5xl mx-auto w-full">
      ...
      <div class="space-y-8">
        ...
        <div class="flex flex-wrap justify-center gap-6 py-8">
          ...
          >
            <div v-if="integration.id === 'travelline'" class="w-16 h-12 bg-blue-600 rounded-lg flex items-center justify-center">
              <span class="text-white font-bold text-xs leading-tight text-center">TRAVEL<br/>LINE</span>
            </div>
            <div v-if="integration.id === 'realtycalendar'" class="w-16 h-12 border border-slate-200 rounded-lg flex items-center justify-center gap-1">
            ...
            <div v-if="integration.id === 'yclients'" class="w-16 h-12 bg-yellow-400 rounded-lg flex items-center justify-center">
    ...
    <SetupNavigation
      ...
      :show-back="false"
      next-label="Выбрать"
      :is-next-disabled="!selectedIntegration"
    />
  </div>
</template>