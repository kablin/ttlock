...
<template>
    <AuthBase title="Регистрация" description="20-дневный бесплатный доступ к неограниченным ресурсам платформы">
        ...
        >
            <div class="grid gap-6">
                ...
                <Button variant="design" type="submit" class="mt-2 w-full" tabindex="5" :disabled="processing" data-test="register-user-button">
