...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full justify-center overflow-x-auto rounded-xl p-4">
                    ...
                    <StepperTrigger>
                        <StepperIndicator v-slot="{ step }" class="bg-muted">
                            <template v-if="item.icon">
                                <component v-html="item.icon" class="" />
                            </template>
